...
OWNER_NAME = getenv("OWNER_NAME", "huybopbii")
OWNER_USERNAME = getenv("OWNER_USERNAME", "huybopbii")
ALIVE_NAME = getenv("ALIVE_NAME", "huybopbi")
BOT_USERNAME = getenv("BOT_USERNAME", "vpnfastt2_bot")
OWNER_ID = getenv("OWNER_ID", "1655741685")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "botvpnf")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "vpnfastteam")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "vpnfastteam")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("UPDATES_CHANNEL", "HEROKU_API_KEY")
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "1655741685").split()))
